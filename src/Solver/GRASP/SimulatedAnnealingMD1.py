...
def GRASP(ins, a, R, T, seconds, isVerbose=False, isTrace=False):
...
print(GRASP(args.ins, args.alpha, args.repeat, args.temperature, args.seconds, args.verbose, args.trace))