...
def GRASP(ins, a, R, T, seconds, isVerbose=False, isTrace=False, totaltime=3600):
    ...
    if isTrace:
        ...
        out_file = 'src/Solver/GRASP/out/annealingMD1-' + str(ins.replace("/", "-").replace(".vrp", "")) + '-r' + str(R) + '-' + str(rn) + '.csv'
...
print(GRASP(args.ins, args.alpha, args.repeat, args.temperature, args.seconds, args.verbose, args.trace, args.totaltime))